...
${HOME}/src/sgaFolhas.py -a ${SAIDA_CSV}/folhas.csv -c ${CALENDARIO} -t ${TIPO_PROVA} -d > ${LOG}/log_full-insertion_sgaFolhas_regular_reverso${DATA}.log
${HOME}/src/sgaFolhas.py -a ${SAIDA_CSV}/folhas.csv -c ${CALENDARIO_DP} -t ${TIPO_PROVA_DP} -d > ${LOG}/log_full-insertion_sgaFolhas_DP_reverso${DATA}.log
