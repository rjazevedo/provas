...
#É uma referencia para os arquivos que foram movidos
mkdir Movidos
...
do
	...
	-o -iname '20190502*png' \) -exec cp -n '{}' ${PATH_PROVAS_1BIM}/$a  \; -exec echo "Copiando " '{}' "para ${PATH_PROVAS_1BIM}/$a" \; -exec mv '{}' ../Movidos \;
	...
	-o -iname '20190712*png' \) -exec cp -n '{}' ${PATH_PROVAS_2BIM}/$a  \; -exec echo "Copiando " '{}' "para ${PATH_PROVAS_2BIM}/$a" \; -exec mv '{}' ../Movidos \;
	#Prova 1DP
	find ./$a/ -type f  \( -iname '20190610*png' \
	-o -iname '20190611*png' \
	-o -iname '20190612*png' \
	-o -iname '20190617*png' \
	-o -iname '20190619*png' \) -exec cp -n '{}' ${PATH_PROVAS_1DP}/$a  \; -exec echo "Copiando " '{}' "para ${PATH_PROVAS_1DP}/$a" \; -exec mv '{}' ../Movidos \;
